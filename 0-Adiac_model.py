...
def generate_model_new():
    ...
    y = BatchNormalization()(y)
    y = Activation('relu')(y)
    y = AveragePooling1D( padding='same')(y)
    y = Dropout(0.3)(y)
 ...
 #   y = BatchNormalization()(y)
  ...
  #  y = squeeze_excite_block(y)
    y = GRU(20, return_sequences=True,kernel_initializer='TruncatedNormal',dropout=0.3, recurrent_dropout=0.3)(y)
    y = BatchNormalization()(y)
    y= Flatten()(y)
...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='adiac', epochs=4000, batch_size=128)
    model.summary()
    accuracy, loss, f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='adiac', batch_size=128)
