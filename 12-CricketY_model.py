...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='cricket_y', epochs=2000, batch_size=128,
                cutoff=None)

    accuracy, loss, f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='cricket_y', batch_size=128,
                   cutoff=None)
