...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='cbf', epochs=2000, batch_size=32)
    summary = model.summary()
    accuracy, loss,f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='cbf', batch_size=128)
