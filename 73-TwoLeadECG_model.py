...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='two_lead_ecg', epochs=2000, batch_size=64)
    model.summary()
    accuracy, loss,f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='two_lead_ecg', batch_size=64)
