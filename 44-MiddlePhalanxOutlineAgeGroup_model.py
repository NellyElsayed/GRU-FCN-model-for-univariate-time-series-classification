...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='middle_phalanx_age_group', epochs=2000, batch_size=128)
    model.summary()
    accuracy, loss, f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='middle_phalanx_age_group', batch_size=128)
