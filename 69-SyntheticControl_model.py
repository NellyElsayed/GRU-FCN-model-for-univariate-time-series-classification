...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='synthetic_control', epochs=4000, batch_size=16)
    model.summary()
    accuracy , loss , f_score= evaluate_model(model, DATASET_INDEX, dataset_prefix='synthetic_control', batch_size=128)
