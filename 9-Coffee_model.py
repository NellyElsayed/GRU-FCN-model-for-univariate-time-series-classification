...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='coffee', epochs=500, batch_size=64)
    summary = model.summary()

    accuracy, loss, f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='coffee', batch_size=64)
