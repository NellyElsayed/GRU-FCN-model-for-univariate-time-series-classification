...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='ford_a', epochs=2000, batch_size=128)

    accuracy, loss, f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='ford_a', batch_size=128)
