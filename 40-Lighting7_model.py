...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='lighting7', epochs=3000, batch_size=32,
                cutoff='pre')
    model.summary()
    accuracy, loss, f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='lighting7', batch_size=32,
                   cutoff='pre')
