...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='insect_wingbeat_sound', epochs=1000, batch_size=128)
    model.summary()
    accuracy, loss, f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='insect_wingbeat_sound', batch_size=128)
