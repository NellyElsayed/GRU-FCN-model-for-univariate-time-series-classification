...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='refrigertation_devices', epochs=2000, batch_size=64)
    model.summary()    
    accuracy, loss,f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='refrigertation_devices', batch_size=64)
