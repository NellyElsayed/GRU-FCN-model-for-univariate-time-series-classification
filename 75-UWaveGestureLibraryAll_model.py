...
if __name__ == "__main__":
    ...
    history =  train_model(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_all', epochs=500, batch_size=16)
    model.summary()
    accuracy, loss, f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_all', batch_size=16)
