...
if __name__ == "__main__":
    ...
    if select == '1':
        ...
        start_time = time.time()
    history = train_model(model, DATASET_INDEX, dataset_prefix='proximal_phalanx_tw', epochs=2000, batch_size=128)
    model.summary()
    accuracy , loss,f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='proximal_phalanx_tw', batch_size=128)
