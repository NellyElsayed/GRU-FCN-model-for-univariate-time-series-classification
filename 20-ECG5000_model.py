...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='ecg5000', epochs=2000, batch_size=128)
    summary = model.summary()
    accuracy, loss , f_score= evaluate_model(model, DATASET_INDEX, dataset_prefix='ecg5000', batch_size=128)
