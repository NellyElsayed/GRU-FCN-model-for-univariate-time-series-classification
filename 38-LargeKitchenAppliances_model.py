...
if __name__ == "__main__":
    ...
    history = train_model(model, DATASET_INDEX, dataset_prefix='large_kitchen_appliances', epochs=2000, batch_size=128)
    model.summary()
    accuracy, loss, f_score = evaluate_model(model, DATASET_INDEX, dataset_prefix='large_kitchen_appliances', batch_size=128)
